...
<body>
  ...
  <br><br><br><br><br>
  <center>
    <h1 style="color:#2b2f3a; text-decoration-line: none; font-family: Helvetica, sans-serif; font-weight: 900;">빠른 설치 - 완료</h1>
    <div style="width: 80%; margin-top: 50px;">
      <div style="background-color: #2b2f3a; display: inline; width: 98%; float: left; border-left-style:solid; border-top-style:solid; border-bottom-style:solid; border-radius: 100px 100px 100px 100px"><h3 style="font-family: Helvetica, sans-serif; font-weight: 900; color: white;">100%</h3></div>
    </div>
    <br>
  </center>
  <br>
  <div style="width: 80%; margin-top: 5%; margin-left: 10%;">
    <h3 style="font-family: Helvetica, sans-serif; font-weight: 900; text-align: center;">네트워크 설정이 끝났습니다. 인터넷을 사용할 수 있습니다.</h3>
    <br><br><br>
