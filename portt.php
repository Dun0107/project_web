...
<div class="position-relative overflow-hidden p-3 p-md-5 m-md-3 text-center bg-light">
  <div class="col-md-9 p-lg-5 mx-auto my-5">
	<h1 class="display-7 font-weight-normal" style="font-weight: 700" >포트 트리거  </h1> <hr>
...
<script>
  ...
  const str = `<li>
        <div class="card" >
          ...
          <form method="post" action="portt_add.php">
          <div class="form-group row ">
          <label style="color:black;" class="col-sm-2 col-form-label">응용 프로그램 :</label>      
          <div class="col-sm-15">
            <input class="form-control" type="text" name="pg"  required>    
          </div>
        </div>
      ...
      <option >UDP</option>
         ...
         <div class="form-group row">
          ...
          <div class="col-sm-15">
            <input class="form-control" type="text" name="oport"  required>    
          </div>
        </div>
