...
<body>
  ...
  <div style="width: 80%; margin-top: 5%; margin-left: 20%;">
    <p style="font-family: Helvetica, sans-serif; font-weight: 900;">사용자의 ISP가 특정 MAC 주소에 대한 인터넷 액세스를 허용하는 경우, 다른 장치에 대한 MAC 주소를 복제해야 합니다. <br>확실하지 않은 경우 MAC 주소를 복제하지 마십시오를 선택합니다.</p><br>
    <input type="checkbox"  /><font style="font-family: Helvetica, sans-serif; font-weight: 900;">MAC 주소를 복제하지 마십시오</font><br>
    <input type="checkbox" /><font style="font-family: Helvetica, sans-serif; font-weight: 900;">현재 컴퓨터 MAC 주소를 복제</font><br>
    <br><br>
    <button type="button" style="margin-left:70%; width:80px; height:40px; border: none; text-align: center; text-decoration: none; display: inline-block; font-size: 15px; border-radius:10px; border-style: solid;">
        <a href="fast.php" style="color: #2b2f3a; text-decoration-line: none; font-family: Helvetica, sans-serif; font-weight: 900; display: inline;">이전</a>
      </button>
    <button type="button" style="width:80px; height:40px; border: none; text-align: center; text-decoration: none; display: inline-block; font-size: 15px; border-radius:10px; border-style: solid;">
        <a href="fast3.php" style="color: #2b2f3a; text-decoration-line: none; font-family: Helvetica, sans-serif; font-weight: 900; display: inline;">다음</a>
      </button>
  </div>
</body>
</html>
